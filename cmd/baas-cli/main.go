...
import (
	...
	"github.com/Ursa-Minor-Beta/baas/pkg/baasclient"
)

func main() {
	var cfg baasclient.Config
...
func startBaasClient(cfg baasclient.Config) {
	client, err := baasclient.BubbleClient(context.Background(), cfg)
	if err != nil {
		panic(err)
	}
